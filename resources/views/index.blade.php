  ...
  <div class="content-wrapper">
	...
	<!-- carousel code -->
		...
		<div class="carousel-inner">
			<!-- first slide -->
			<div class="carousel-anim carousel-item text-right active">
				<div class="carousel-anim">
					...
					<li data-animation="animated flipInX">
					    Les etudiants des Cours Sonou Calavi
					</li>
					<li data-animation="animated flipInX">
					  Les planificateurs de l'éducation,
					</li>
					<li data-animation="animated flipInX">
					  Les décideurs du système éducatif,
					</li>
					<li data-animation="animated flipInX">
			...
			<div class="carousel-item text-right">
				<div class="carousel-anim">
					...
					<ol>
					<li data-animation="animated flipInX">
            Faciliter la consultation des resultats de fin de semestre,
					</li>
					<li data-animation="animated flipInX">
					  Renforcer les capacités de planification, de suivi et d’évaluation,
					</li>
					<li data-animation="animated flipInX">
					  Dynamiser le suivi des établissements scolaires publics et privés,
					</li>
					<li data-animation="animated flipInX">
					  Accroître les capacités en matière de régulation et d’encadrement.
					</li>
					</ol>
				</div>
			</div>
